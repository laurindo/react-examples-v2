...
function Header(props) {
  ...
  const activeSubmenu = id => {
    if (disableSubmenu && disableSubmenu.cancel) disableSubmenu.cancel();
    return setSubmenu(id);
  };

  const disableSubmenu = _.debounce(id => {
    setSubmenu(null);
  }, 200);
  ...
  const displayListDesktop = () => {
    return (
      <>
        <li><a rel="noopener noreferrer" href="#/" onMouseEnter={() => activeSubmenu("ui")} onMouseLeave={() => disableSubmenu(null)}>UI</a></li>
        <li><a rel="noopener noreferrer" href="#/" onMouseEnter={() => activeSubmenu("media")} onMouseLeave={() => disableSubmenu(null)}>Media</a></li>
        <li><a rel="noopener noreferrer" href="#/" onMouseEnter={() => activeSubmenu("element")} onMouseLeave={() => disableSubmenu(null)}>Elements</a></li>
        <li><a rel="noopener noreferrer" href="#/" onMouseEnter={() => activeSubmenu("input")} onMouseLeave={() => disableSubmenu(null)}>Input</a></li>
      </>
    );
  };
  ...
  const displayMenu = () => {
    return (
      <ul className="headerMenu">
        ...
        <li><a href="https://dslaurindo.typeform.com/to/DaSEYEa9" target="_blank" rel="noopener noreferrer">CONTRIBUTE</a></li>
        <li>
